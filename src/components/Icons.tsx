...
export const Edit = require('-!svg-react-loader?name=Icon!feather-icons/dist/icons/sliders.svg');
export const Settings = require('-!svg-react-loader?name=Icon!feather-icons/dist/icons/settings.svg');
